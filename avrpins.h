...
#elif defined(CORE_TEENSY) && ((defined(__IMXRT1052__) || defined(__IMXRT1062__))
...
#define MAKE_PIN(className, baseReg, pinNum, configReg, padReg) \
class className { \
public: \
  static void Set() { \
    *portSetRegister(pinNum) = digitalPinToBitMask(pinNum); \
...
MAKE_PIN(P0, CORE_PIN0_PORTREG, 0, CORE_PIN0_CONFIG, CORE_PIN0_PADCONFIG);
MAKE_PIN(P1, CORE_PIN1_PORTREG, 1, CORE_PIN1_CONFIG, CORE_PIN1_PADCONFIG);
MAKE_PIN(P2, CORE_PIN2_PORTREG, 2, CORE_PIN2_CONFIG, CORE_PIN2_PADCONFIG);
MAKE_PIN(P3, CORE_PIN3_PORTREG, 3, CORE_PIN3_CONFIG, CORE_PIN3_PADCONFIG);
MAKE_PIN(P4, CORE_PIN4_PORTREG, 4, CORE_PIN4_CONFIG, CORE_PIN4_PADCONFIG);
MAKE_PIN(P5, CORE_PIN5_PORTREG, 5, CORE_PIN5_CONFIG, CORE_PIN5_PADCONFIG);
MAKE_PIN(P6, CORE_PIN6_PORTREG, 6, CORE_PIN6_CONFIG, CORE_PIN6_PADCONFIG);
MAKE_PIN(P7, CORE_PIN7_PORTREG, 7, CORE_PIN7_CONFIG, CORE_PIN7_PADCONFIG);
MAKE_PIN(P8, CORE_PIN8_PORTREG, 8, CORE_PIN8_CONFIG, CORE_PIN8_PADCONFIG);
MAKE_PIN(P9, CORE_PIN9_PORTREG, 9, CORE_PIN9_CONFIG, CORE_PIN9_PADCONFIG);
MAKE_PIN(P10, CORE_PIN10_PORTREG, 10, CORE_PIN10_CONFIG, CORE_PIN10_PADCONFIG);
MAKE_PIN(P11, CORE_PIN11_PORTREG, 11, CORE_PIN11_CONFIG, CORE_PIN11_PADCONFIG);
MAKE_PIN(P12, CORE_PIN12_PORTREG, 12, CORE_PIN12_CONFIG, CORE_PIN12_PADCONFIG);
MAKE_PIN(P13, CORE_PIN13_PORTREG, 13, CORE_PIN13_CONFIG, CORE_PIN13_PADCONFIG);
MAKE_PIN(P14, CORE_PIN14_PORTREG, 14, CORE_PIN14_CONFIG, CORE_PIN14_PADCONFIG);
MAKE_PIN(P15, CORE_PIN15_PORTREG, 15, CORE_PIN15_CONFIG, CORE_PIN15_PADCONFIG);
MAKE_PIN(P16, CORE_PIN16_PORTREG, 16, CORE_PIN16_CONFIG, CORE_PIN16_PADCONFIG);
MAKE_PIN(P17, CORE_PIN17_PORTREG, 17, CORE_PIN17_CONFIG, CORE_PIN17_PADCONFIG);
MAKE_PIN(P18, CORE_PIN18_PORTREG, 18, CORE_PIN18_CONFIG, CORE_PIN18_PADCONFIG);
MAKE_PIN(P19, CORE_PIN19_PORTREG, 19, CORE_PIN19_CONFIG, CORE_PIN19_PADCONFIG);
MAKE_PIN(P20, CORE_PIN20_PORTREG, 20, CORE_PIN20_CONFIG, CORE_PIN20_PADCONFIG);
MAKE_PIN(P21, CORE_PIN21_PORTREG, 21, CORE_PIN21_CONFIG, CORE_PIN21_PADCONFIG);
MAKE_PIN(P22, CORE_PIN22_PORTREG, 22, CORE_PIN22_CONFIG, CORE_PIN22_PADCONFIG);
MAKE_PIN(P23, CORE_PIN23_PORTREG, 23, CORE_PIN23_CONFIG, CORE_PIN23_PADCONFIG);

MAKE_PIN(P24, CORE_PIN24_PORTREG, 24, CORE_PIN24_CONFIG, CORE_PIN24_PADCONFIG);
MAKE_PIN(P25, CORE_PIN25_PORTREG, 25, CORE_PIN25_CONFIG, CORE_PIN25_PADCONFIG);
MAKE_PIN(P26, CORE_PIN26_PORTREG, 26, CORE_PIN26_CONFIG, CORE_PIN26_PADCONFIG);
MAKE_PIN(P27, CORE_PIN27_PORTREG, 27, CORE_PIN27_CONFIG, CORE_PIN27_PADCONFIG);
MAKE_PIN(P28, CORE_PIN28_PORTREG, 28, CORE_PIN28_CONFIG, CORE_PIN28_PADCONFIG);
MAKE_PIN(P29, CORE_PIN29_PORTREG, 29, CORE_PIN29_CONFIG, CORE_PIN29_PADCONFIG);
MAKE_PIN(P30, CORE_PIN30_PORTREG, 30, CORE_PIN30_CONFIG, CORE_PIN30_PADCONFIG);
MAKE_PIN(P31, CORE_PIN31_PORTREG, 31, CORE_PIN31_CONFIG, CORE_PIN31_PADCONFIG);
MAKE_PIN(P32, CORE_PIN32_PORTREG, 32, CORE_PIN32_CONFIG, CORE_PIN32_PADCONFIG);
MAKE_PIN(P33, CORE_PIN33_PORTREG, 33, CORE_PIN33_CONFIG, CORE_PIN33_PADCONFIG);
#undef MAKE_PIN
